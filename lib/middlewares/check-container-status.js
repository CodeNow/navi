 ...
 * @param {object} req Request Object
 * @returns {string} Computed URL in format of http(s)://DOCKER_HOST:MAPPED_PORT
 * @private
 */
module.exports._getUrlFromNaviEntryInstance = function _getUrlFromNaviEntryInstance(req) {
  return Api.getTargetUrl(req.isHttps, req.parsedReqUrl, req.targetNaviEntryInstance);
};
