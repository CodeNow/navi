...
module.exports.middleware = function (req, res, next) {
  ...
  module.exports.getMongoEntry(req, function (err) {
    ...
    if (req.isHttps && !directModel.ports.contains(req.parsedReqUrl.port) && directModel.ports.contains(80)) {
...
function getDirectUrlModelFromNaviEntry (naviEntry, shortHash) {
  if (shortHash === '') {
    return Object.keys(naviEntry.directUrls).find(function (key) {
