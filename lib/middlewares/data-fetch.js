...
module.exports.middleware = function (req, res, next) {
  ...
  module.exports.getMongoEntry(req, function (err) {
    ...
    if (req.isHttps && directModel && !directModel.ports.contains(usedPort) && directModel.ports.contains('80')) {
...
function getMasterPod (naviEntry) {
...
function getDirectUrlModelFromNaviEntry (naviEntry, shortHash) {
  if (!shortHash) {
    return getMasterPod(naviEntry, shortHash)
  }
