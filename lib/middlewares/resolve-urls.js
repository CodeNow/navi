...
function splitDirectUrlIntoShorthashAndElastic(directUrl) {
  ...
  log.error({
    directUrl: directUrl
  }, 'splitDirectUrlIntoShorthashAndElastic got a direct url');
  return {
    shortHash: '',
...
module.exports.splitDirectUrlIntoShorthashAndElastic = splitDirectUrlIntoShorthashAndElastic
...
module.exports.resolveUrl = function resolveUrl(req, requestedHost, naviEntry) {
  ...
  if (naviEntry.elasticUrl === requestedHost) {
    ...
    resolvedId = splitDirectUrlIntoShorthashAndElastic(requestedHost).shortHash
  }
