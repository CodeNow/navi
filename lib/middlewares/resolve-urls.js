 ...
 */
module.exports = function resolveUrlMiddleware(req, res, next) {
  // Order is important!
  req.resolvedReferrerId = module.exports.resolveUrl(req, req.headers.referer, req.naviEntry.refererNaviEntry);
