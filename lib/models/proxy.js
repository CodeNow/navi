...
Proxy.prototype.proxyIfTargetHostExist = function () {
  ...
  return function (req, res, next) {
    ...
    self.proxy.on('start', function () {
      ...
      req.headers['x-forwarded-protocol'] = req.parsedReqUrl.protocol;
      req.headers['x-forwarded-proto'] = req.parsedReqUrl.protocol;
      req.headers['x-forwarded-port'] = req.parsedReqUrl.port;
