...
function Proxy () {
  ...
  this.proxy.on('error', function (err, req/*, proxiedRes */) {
    ...
    monitor.increment('navi.url-error.count', {
      isBrowser: req.isBrowser,
      orgName: ownerUsername,
      org: ownerGithubId
    });
    /**
...
Proxy.prototype.proxyIfTargetHostExist = function () {
  ...
  return function (req, res, next) {
    ...
    monitor.increment('navi.url-proxied.count', tags);
    monitor.timing('navi.overhead.time', new Date() - req.startTime, tags);
