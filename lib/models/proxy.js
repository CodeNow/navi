...
var xhrPatchScriptPath = path.resolve(__dirname, '../templates/patch-xhr-with-credentials.js');
console.log(xhrPatchScriptPath);
...
Proxy.prototype._streamRes = function (targetRes, proxiedRes, res) {
  ...
  console.log('targetRes HEADERS', targetRes.headers, targetRes._headers);
  console.log('proxiedRes HEADERS', proxiedRes.headers, proxiedRes._headers);
  if (resIsHtml) {
...
Proxy.prototype._addHeadersToRes = function (req, res, targetInstanceName) {
  console.log('REQ HEADERS', req.headers, req._headers);
